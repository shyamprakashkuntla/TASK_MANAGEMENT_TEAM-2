...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    /**
     * This method decides whether the filter should run or not.
     * If true, `doFilterInternal` is skipped.
     */
    @Override
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            if (tokenBlacklistRepository.existsByJtiAndExpiresAtAfter(jti, LocalDateTime.now())) {
